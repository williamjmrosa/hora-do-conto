...
<body class="primaria">
	...
	<div class="d-flex flex-column flex-shrink-0 p-3 text-white terciaria"
		style="width: 25%;">
		...
		<input type="text" placeholder="Pesquisar..." class="perquisar border-0 border-bottom bg-transparent border-dark mb-4">
		
		<ul id="menu-lateral" class="nav nav-pills flex-column mb-auto menu-lateral">
			<li class="nav-item"><a href="#" class="nav-link text-white" aria-current="page">Atividade</a>
				<ul class="list-unstyled ">
					<li class="mb-2"><a class="text-secundaria ms-4" href="">Conto 1: Teste</a></li>
					<li class="mb-2"><a class="text-secundaria ms-4 " href="">Atividade</a></li>
				</ul>
			</li>
			<li><a href="#" class="nav-link text-white">Atividade 2</a>
				<ul class="list-unstyled ">
					<li class="mb-2"><a class="text-secundaria ms-4" href="">Conto 1: Teste</a></li>
					<li class="mb-2"><a class="text-secundaria ms-4 " href="">Atividade</a></li>
				</ul>
			</li>
			<li><a href="#" class="nav-link text-white">Atividade 3</a></li>
			<li><a href="#" class="nav-link text-white">Atividade 4</a></li>
			<li><a href="#" class="nav-link text-white">Atividade 5</a></li>			
		</ul>
		<hr>
	</div>
